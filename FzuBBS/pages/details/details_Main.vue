<template>
	<view >
		...
		<view class="Hot-Post page-block">
			...
			<view v-for="detObj in details" class="single-hot-post" @click="det()">
		...
		data() {
			return {
				details:[
					{
						title:"咨询解答转专业的一切疑问",
						content:"今年转专业工作已经开始了，相比去年有小差，申请条件不看成绩绩点了,lz往年成功转专业成功，当时也很困惑找不到人询问，所以今年为学弟学妹无偿在线解答所有转专业问题,咨询前先要了解教务处转专业17年公告",
